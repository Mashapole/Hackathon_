...
include "../Connection/Db.php";
	...
	if(isset($_POST['btnDonate']))
	{
		...
		$query = "INSERT INTO books(Tittle,ISBN,author_name,Description,Image,Publisher,Category,Student_Number) VALUES ('" . $title . "', '" . $isbn . "', '" . $author . "', '" . $description . "', '" .$image. "', '" . $publisher . "','".$category."', '" . $getStudent . "')";
...
<div class="topnav">
  ...
  <a href="../Admin/Add_book.php" class="active">Add Book</a>
